...
class TitlePapers():
    ...
    def make_agreement(self):
        lien_blurb = 'I, ' + self.borrower + ' of ' + self.borrower_group + ', will pay ' + self.lien_holder + ' of ' + self.lien_holder_group + ' CR ' + str(
            self.payment_amount) + ' for ' + str(
            self.lease_months) + ' months. \nPayment is due on the first day of each month and is to be presented at ' + self.payment_location + '.'
        return lien_blurb
...
class Hull(Spec):
    def __init__(self, config='Wedge', hull_class='4', _random=False, fuel_scoops=False):
        ...
        hull_prices = {'1': 2, '2': 8, '3': 12, '4': 16, '5': 32, '6': 48, '7': 64, '8': 80, '9': 90, 'A': 100,
                       'B': 110, 'C': 120, 'D': 130, 'E': 140, 'F': 150, 'G': 160, 'H': 170, 'J': 180, 'K': 190,
                       'L': 200}
        ...
        if self.fuel_scoops and self.configuration != 'Streamlined':
            hull_price += 1000000
        super().__init__(num=hull_class, spec=self.configuration, cost=int(hull_price * 1000000),
                         tons=int(hexSwitch(hull_class) * 100))


class Armor():
    def __init__(self, hull, titanium_steel=0, crystaliron=0, bonded_superdense=0, reflec=False, self_sealing=False,
                 stealth=False, _random=False):
        if _random == True:
        ...
        if self_sealing == True:
            ...
            self.self_sealing = Spec(cost=t * 10000)
        if reflec == True:
            self.reflec = Spec(num=1, cost=t * 100000)
            self.tl = 10
        else:
            self.reflec = Spec(cost=t * 100000)
...
class Drive(Spec):
    ...
    def scope(self, desired_rating, troubleshooting=False):
        drive_performance = [{1: 1}, {1: 2, 2: 4, 3: 6},
                             ...
                             {3: 1, 4: 1, 5: 2, 6: 2, 7: 2, 8: 3, 9: 3, 10: 4, 11: 4, 12: 4, 13: 5, 14: 5, 15: 6, 16: 6,
                              17: 6},
                             {3: 1, 4: 1, 5: 2, 6: 3, 7: 3, 8: 2, 9: 3, 10: 3, 11: 3, 12: 4, 13: 4, 14: 4, 15: 5, 16: 5,
                              17: 5, 18: 6, 19: 6, 20: 6},
                             {4: 1, 5: 1, 6: 1, 7: 2, 8: 2, 9: 2, 10: 3, 11: 3, 12: 3, 13: 4, 14: 4, 15: 4, 16: 5,
                              17: 5, 18: 5, 19: 6, 20: 6, 21: 6, 22: 6, 23: 6, 24: 6},
                             {4: 1, 5: 1, 6: 1, 7: 2, 8: 2, 9: 2, 10: 3, 11: 3, 12: 3, 13: 4, 14: 4, 15: 4, 16: 5,
                              17: 5, 18: 5, 19: 5, 20: 6, 21: 6, 22: 6, 23: 6, 24: 6},
                             {5: 1, 6: 1, 7: 1, 8: 2, 9: 2, 10: 2, 11: 3, 12: 3, 13: 3, 14: 4, 15: 4, 16: 4, 17: 5,
                              18: 5, 19: 5, 20: 5, 21: 6, 22: 6, 23: 6, 24: 6},
                             {5: 1, 6: 1, 7: 1, 8: 2, 9: 2, 10: 2, 11: 3, 12: 3, 13: 3, 14: 4, 15: 4, 16: 4, 17: 5,
                              18: 5, 19: 5, 20: 5, 21: 5, 22: 6, 23: 6, 24: 6},
                             {6: 1, 7: 1, 8: 1, 9: 1, 10: 2, 11: 2, 12: 2, 13: 3, 14: 3, 15: 3, 16: 4, 17: 4, 18: 4,
                              19: 4, 20: 5, 21: 5, 22: 5, 23: 5, 24: 5},
                             {7: 1, 8: 1, 9: 1, 10: 2, 11: 2, 12: 2, 13: 3, 14: 3, 15: 3, 16: 4, 17: 4, 18: 4, 19: 4,
                              20: 5, 21: 5, 22: 5, 23: 5, 24: 5},
                             {8: 1, 9: 1, 10: 1, 11: 2, 12: 2, 13: 2, 14: 3, 15: 3, 16: 3, 17: 4, 18: 4, 19: 4, 20: 4,
                              21: 4, 22: 5, 23: 5, 24: 5},
                             {9: 1, 10: 1, 11: 1, 12: 2, 13: 2, 14: 2, 15: 3, 16: 3, 17: 3, 18: 4, 19: 4, 20: 4, 21: 4,
                              22: 4, 23: 4, 24: 5},
                             {10: 1, 11: 1, 12: 2, 13: 2, 14: 2, 15: 3, 16: 3, 17: 3, 18: 4, 19: 4, 20: 4, 21: 4, 22: 4,
                              23: 4, 24: 5}]
        range_tool = [[1, 1], [1, 3], [1, 6], [2, 9], [2, 13], [3, 17], [3, 20], [4, 24], [4, 24], [5, 24], [5, 24],
                      [6, 24], [7, 24], [8, 24], [9, 24]]
        if self.hull_code > 9:
            hc = ((self.hull_code - 9) // 2) + 9
        else:
            hc = self.hull_code
        result = 0
        ret_result = 0
...
class SensorSuite(Spec):
    def __init__(self, spec):
        if spec == 'Random': spec = random.choice(
            ['Standard', 'Basic Civilian', 'Basic Military', 'Advanced', 'Very Advanced'])
        ...
        if spec == 'Very Advanced': s = [12, 2, ['Radar', 'Lidar', 'Densitometer', 'Jammers', 'Neural Activity Sensor'],
                                         5, 4000000]
        self.tl = s[0]
        self.mod = s[1]
        self.equipment = s[2]
...
class Hardpoint(Spec):  # WILL HAE TO CHANGE RANGE INTO A NUMBER INSTEAD OF RELATIVE
    def __init__(self, turrets=-1, bay='No Bay', screen='No Screen', popup=False, fixed=False, _random=False,
                 _random_turret=False):
        ...
        if _random:
            ...
            if 7 < x <= 9: turrets = [random.choice(turrets_list), random.choice(turrets_list),
                                      random.choice(turrets_list)]
            if x == 10:
                y = d(1, 2, 0)
...
class SpaceVessel():
    def __init__(self, _random=True, hardpoint_budget=3, thrust=3, jump=1):
        ...
        self.available_hull = self.hull.tons - (
                    self.armor.tons + self.mdrive._tons() + self.jdrive._tons() + self.pplant._tons() + self.fuel[1])
    ...
    def print(self):
        ...
        print('Class ' + self.hull.num + ' ' + self.hull.body + ' (' + hexSwitch(self.mdrive.num) + '-' + hexSwitch(
            self.jdrive.num) + '-' + hexSwitch(self.pplant.num) + ')')
        print('Fuel Tank: ' + str(self.fuel[1]))
        print(str(self.stats.cost) + ' CR @ ' + str(self.title_papers.apy) + '% APY')
        print(
            str(self.title_papers.payment_amount) + ' CR / mo. for ' + str(self.title_papers.lease_months) + ' months')
        self.stats.print()
        print('Available: ' + str(self.available_hull) + ' tons')
        self.armor.print()
        weaponry_total = 0
        for weapon in self.hardpoints:
            weaponry_total += weapon.cost
        print('Weaponry Value: ' + str(weaponry_total / 1000000) + ' MCr.')
        self.sensors.print()
