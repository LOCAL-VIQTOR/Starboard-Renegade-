...
class lifepath():
    ...
    def addSkills(self,character):
        for i in range(len(self.skills)):
            character.skills.train(character,self.skills[i][0],self.skills[i][1])
        

    def education_skills(self,character):
    ...
    def navy_career(self, assignment, term, draft):
        ...
        enlistment = d(2,6,characteristic_modifier(charachter.intel))
        if enlistment >= 6:
